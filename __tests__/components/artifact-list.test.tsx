...
function setupMockSWR(
  artifacts: ArtifactResponse[],
  opts?: { isLoading?: boolean; error?: Error },
) {
  mockUseSWR.mockReturnValue(
    mockSWR<{ artifacts: ArtifactResponse[] }>({
...
describe("ArtifactList", () => {
  ...
  it('renders "Done" AI review status badge', () => {
    ...
    expect(
      screen.getByRole("link", { name: /View review/i }),
    ).toBeInTheDocument();
  });
  ...
  it('renders "Pending" AI review status badge', () => {
    ...
    expect(
      screen.getByLabelText("AI review status: Pending"),
    ).toBeInTheDocument();
    expect(
      screen.queryByRole("link", { name: /View review/i }),
  ...
  it("shows delete button only when canDelete returns true", () => {
    ...
    expect(
      screen.queryByRole("button", { name: /Delete report\.pdf/i }),
    ).not.toBeInTheDocument();
  ...
  it("renders upload form with file input and button", () => {
    ...
    expect(
      screen.getByRole("button", { name: /Upload artifact/i }),
    ).toBeInTheDocument();
